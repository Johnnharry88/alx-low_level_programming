...
/**
 * check_elf - function that chaeck out for an ELF file
...
/**
 * print_data - Displayss the data of an ELF header.
...
/**
 * print_type - Displays the ELF header type.
 * @e_type: ELF type.
 * @e_ident: pointer to an array holding the ELF class.
 * Return: void.
 */
